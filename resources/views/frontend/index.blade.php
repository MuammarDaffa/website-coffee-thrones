    ...
    <section class="hero" id="home">
        <div class="container hero-content">
            <div class="hero-text">
                ...
                <h1>Thrones Cafe</h1>
                <p>Nikmati paduan sempurna kopi premium, suasana yang nyaman, dan pelayanan istimewa di Thrones Cafe.
                    Singgasana Anda telah menanti.</p>
        ...
        <div class="container">
            ...
            <div class="about-content">
                <div class="about-text">
                    <p>Didirikan pada tahun 2015, Throne Cafe bermula dari sebuah mimpi sederhana untuk menciptakan
                        ruang di mana para pecinta kopi dapat berkumpul, berkoneksi, dan menikmati seduhan terbaik dalam
                        suasana yang elegan namun tetap ramah.</p>
                    <p>Nama kami mencerminkan komitmen untuk memberikan pengalaman kopi yang berkelas, di mana setiap
                        detail diperhatikan dengan cermat untuk membuat kunjungan Anda terasa istimewa. Dari biji kopi
                        yang dipilih dengan etis hingga barista terampil kami, kami bangga dengan setiap cangkir yang
                        kami sajikan.</p>
                    <p>Kini, Throne Cafe terus menjadi destinasi favorit para pecinta kopi, menawarkan tempat yang
                        nyaman untuk melepaskan diri dari kesibukan hidup sehari-hari.</p>
                </div>
                    ...
                    @forelse($kopi as $item)
                        <div class="menu-item-elegant">
                            <div class="menu-item-header-elegant">
                                ...
                                <span class="menu-item-price-elegant">Rp
...
<section class="gallery" id="gallery">
    ...
    @foreach ($galeri as $index => $item)
        <div class="gallery-item {{ in_array($index, [1,4,7]) ? 'tall' : '' }}">
            <div class="gallery-thumb">
                <img src="{{ asset('storage/' . $item->gambar) }}" alt="Galeri {{ $index+1 }}">
                <div class="gallery-overlay">
                    <div class="overlay-text">
                        {{ $item->deskripsi ?? 'Galeri Warung Kopi Thrones' }}
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <table class="hours-table">
                            @foreach ($jam_operasional as $jam)
                                <tr>
                                    <td>{{ $jam->day_group }}</td>
                                    <td>
                                        {{ \Carbon\Carbon::parse($jam->open_time)->format('H:i') }} -
                                        {{ \Carbon\Carbon::parse($jam->close_time)->format('H:i') }} WIB
                                    </td>
                                </tr>
                            @endforeach
                        </table>
    ...
    <footer>
        <div class="container">
            ...
            <p class="footer-text">Nikmati paduan sempurna kopi premium, suasana yang nyaman, dan pelayanan istimewa di
                Thrones Cafe. Singgasana Anda telah menanti.</p>

            <div class="social-icons">
                <a href="https://www.instagram.com/share/BAL0mWIUcC" target="_blank" class="social-icon instagram">
                    <i class="fab fa-instagram"></i>
                </a>
                <a href="https://www.facebook.com/share/17CBzqSdQ1/?mibextid=wwXIfr" target="_blank"
                    class="social-icon facebook">
                    <i class="fab fa-facebook-f"></i>
                </a>
                <a href="https://www.tiktok.com/@kedaikopithrones?_t=ZS-90ZLgJTAx85&_r=1" target="_blank"
